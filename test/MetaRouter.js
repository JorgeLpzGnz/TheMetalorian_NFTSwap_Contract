...
//                 const { metaRouter, metaFactory, nft, linearCurve } = await loadFixture(deployMetaFactory)

//                 const { sellInfo } = await createTradePoolsTypeLinear( 10, metaFactory, nft, linearCurve )

//                 const timeStamp = (await provider.getBlock()).timestamp

//                 console.log(timeStamp)

//                 await metaRouter.swapNFTForToken( sellInfo, timeStamp + 2 * 6000 )
